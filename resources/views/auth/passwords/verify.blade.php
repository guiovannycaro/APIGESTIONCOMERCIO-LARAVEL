                ...
                <tr>
                    <td align="center" valign="center" style="text-align:center; padding: 10px">
                        <a href="https://souysoeng.com" rel="noopener" target="_blank">
                            <img alt="Logo"
                                src="https://blogger.googleusercontent.com/img/a/AVvXsEi22QSrQgGkTlZ_KdmZx9jRwqTe40SpFx41DukLyxBKKK36XsOCHlPj9NA_ecEZ_ju3Olrt_HcLVrnLXn5Kjgx8pFgPeWslLIJhVu0-Yb5ehLElSJGdsNVamMWksTq8M6-M2_JTtx-2ge_CYS9i_sPgX7noLlbjLbQjFfVXUVS4vxyyp6ULiBR1FxXmYzDO=s256"
                                style="min-height:30px;width: 15%;">
                        </a>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="center">
                        <div
                            ...
                            <div style="padding-bottom: 40px; text-align:center;">
                                <a href="{{ url('reset/password/' . $token) }}" rel="noopener" target="_blank"
